          ...
          {toasts.map((t) => (
            <div
              ...
              style={{
                marginBottom: 8,
                padding: '8px 12px',
                background: t.type === 'success' ? 'rgba(16,185,129,0.1)' : 'rgba(239,68,68,0.08)',
                borderRadius: 6,
            ...
            >
              ...
              <button aria-label="Dismiss" onClick={() => remove(t.id)} style={{ background: 'transparent', border: 'none', cursor: 'pointer' }}>
                ×
              </button>
            </div>
          ))}
